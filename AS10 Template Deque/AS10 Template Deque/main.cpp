...
int main()
{
    ...
    cout << "\nFront item: " << dq.getFront()
         << "\nNumber of items in Deque: " << dq.getSize();
    ...
    cout << "\nTime elipsed: " << run3 << " seconds"
         ...
         << " to " << dq3.getRear();
    cout << "\ndq3[0] is " << dq3[0]
    << ", dq3[1000] is " << dq3[1000] <<endl;
    cout << "dq3[10001] is " << dq3[10001]; //Testing out of range subscript
         
    cout << "\nAt this time, dq size is " << dq.getSize() <<endl;
